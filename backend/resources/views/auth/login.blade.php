...
<head>
    ...
    <title>Login - Portal da ONG</title>
...
<body class="bg-gray-100 font-sans text-gray-900 min-h-screen flex flex-col justify-between">
    ...
    <main class="flex-grow flex items-center justify-center p-4">
        <div class="max-w-md w-full bg-white p-6 rounded-lg shadow-md border">
            <h2 class="text-2xl font-bold mb-6 text-gray-800 text-center">Entrar no Sistema</h2>
            ...
            <p class="mt-4 text-center text-sm text-gray-600">
                Ainda não possui conta? <a href="{{ route('register') }}" class="text-blue-600 hover:underline">Cadastre-se</a>
            </p>
        </div>
    </main>
