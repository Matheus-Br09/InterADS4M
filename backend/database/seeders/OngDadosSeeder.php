...
class OngDadosSeeder extends Seeder
{
    public function run(): void
    {
        $apoiador1 = Apoiador::firstOrCreate(
            ['email' => 'matheusfigueiredo949@gmail.com'],
            [
                'nome_completo' => 'Matheus Figueiredo',
                'senha' => '$2y$10$TNIipK2olHsBFO5Saqu2zuw.0Fe73ABrh2VNHZ59MqLaEGWm0rsC.',
                'celular' => '81985746105',
                'cpf' => '12378945610',
                'sexo' => 'Masculino',
                'cep' => '54220140',
        ...
        $apoiador2 = Apoiador::firstOrCreate(
            ['email' => 'nilloroger@gmail.com'],
            [
                'nome_completo' => 'Danillo roger',
                'senha' => '$2y$10$cqv4dY15DauS1lpg09VhaO2eWHUM0ONzSnRvS2kO6U9t6jT30OZGy',
                'celular' => '81900112233',
                'cpf' => '12378945611',
                'sexo' => 'Feminino',
                'cep' => '54220140',
        ...
        $admin = Apoiador::firstOrCreate(
            ['email' => 'carol@sos.org.br'],
            [
                'nome_completo' => 'Carol',
                'senha' => '$2y$10$LBs3d/jDszUXH5EAIfw5messh59k4N4GOSvmRlCY87LHM.cz7cTEC',
                'celular' => '',
                'cpf' => '',
                'sexo' => 'Masculino',
                'cep' => '',
